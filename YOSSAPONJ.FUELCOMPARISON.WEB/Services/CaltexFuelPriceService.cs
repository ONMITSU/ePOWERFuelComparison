...
namespace YOSSAPONJ.FUELCOMPARISON.WEB.Services
{
    public class CaltexFuelPriceService : ICaltexFuelPriceService
    {
        ...
        private readonly string _baseURL = "https://kaolheneotvu.ap-southeast-1.clawcloudrun.com/Proxy";
        ...
        {
            HttpResponseMessage response = await _httpClient.GetAsync(_baseURL + "/CaltexFuelPrice");
